...
process EXTERNAL_LD_ATAC_MERGE_eigenMT_permute {
    container 'ndatth/rasqual:v0.0.0'
    publishDir "${params.outdir}/EXTERNAL_LD_ATAC_eigenMT_results_merged_permute", mode: 'copy', overwrite: true
    memory '8 GB'
    cpus 1
...
process EXTERNAL_LD_ATAC_MERGE_rasqual_normial {
    container 'ndatth/rasqual:v0.0.0'
    publishDir "${params.outdir}/EXTERNAL_LD_ATAC_MERGE_rasqual_normial", mode: 'symlink', overwrite: true
    memory '8 GB'
    cpus 1
...
process EXTERNAL_LD_ATAC_MERGE_rasqual_normial_permute {
    container 'ndatth/rasqual:v0.0.0'
    publishDir "${params.outdir}/EXTERNAL_LD_ATAC_MERGE_rasqual_normial_permute", mode: 'symlink', overwrite: true
    memory '8 GB'
    cpus 1
...
process EXTERNAL_LD_ATAC_GET_lead_SNP {
    container 'ndatth/rasqual:v0.0.0'
    publishDir "${params.outdir}/EXTERNAL_LD_ATAC_GET_lead_SNP", mode: 'copy', overwrite: true
    memory '8 GB'
    cpus 1
...
process EXTERNAL_LD_ATAC_GET_lead_SNP_permute {
    container 'ndatth/rasqual:v0.0.0'
    publishDir "${params.outdir}/EXTERNAL_LD_ATAC_GET_lead_SNP_permute", mode: 'copy', overwrite: true
    memory '8 GB'
    cpus 1
