...
process EXTERNAL_LD_RNA_MERGE_rasqual_normial {
    container 'ndatth/rasqual:v0.0.0'
    publishDir "${params.outdir}/EXTERNAL_LD_RNA_MERGE_rasqual_normial", mode: 'symlink', overwrite: true
    memory '8 GB'
    cpus 1
...
process EXTERNAL_LD_RNA_MERGE_rasqual_normial_permute {
    container 'ndatth/rasqual:v0.0.0'
    publishDir "${params.outdir}/EXTERNAL_LD_RNA_MERGE_rasqual_normial_permute", mode: 'symlink', overwrite: true
    memory '8 GB'
    cpus 1
